...
const NotificationPopup = () => {
  ...
  return (
    <div
      className="w-screen h-[12.5%] flex justify-center items-center py-[1%] fixed left-0 top-0 right-0"
      style={{ zIndex: 2147483647 }}
    >
      <div
        className={`w-[33%] h-full ${getBackgroundColor()} flex justify-center items-center rounded-lg shadow-md p-[1%] animate-slideTopToBottom`}
      >
