...
const DeleteModal = () => {
  const { deleteProductById, setIsDeleteModal } = useContext(adminContext);
  ...
  return (
    <div className="w-screen h-screen bg-neutral-black-dark/50 flex justify-center items-center fixed left-0 top-0 right-0 bottom-0 z-50">
      <div className="w-[25%] h-[20%] bg-neutral-white rounded-3xl shadow-md p-[0.5%] animate-slideTopToBottom">
        <div className="w-full h-full flex flex-col justify-between items-center">
          <div className="w-full h-[70%] flex justify-center items-center">
            <p className="font-semibold text-base text-neutral-black-dark text-center">
